...
int main(void)
{
    ...
    P1DIR |= BIT0; //sets p1 bit 0 as an output
    P1OUT=0x00; //Turns led off
    P1DIR |= BIT1; //sets p1 bit 0 as an output
    P1OUT=0x00; //Turns led off
    ...
    TB0CCR1=62500; // sets CCR1 interupt value

    TB0CCR2=30000; // sets CCR2 interupt value
